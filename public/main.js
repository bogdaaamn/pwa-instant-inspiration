...
window.onload = function () {
  if (navigator.onLine) networkStatus = 1;else networkStatus = 0;
  ...
  dbPromise = _idb2.default.open('instant-inspiration', 1, function (upgradeDb) {
...
var fetchQuote = function fetchQuote(intervalCall) {
  ...
  fetch(proxyUrl + url).then(function (response) {
    ...
    dbPromise.then(function (db) {
      ...
      if (quotesCounter > 19 && intervalCall) {
        //STOP the fetching after 20 quotes per session
        clearInterval(intervalId);
        intervalRunning = 0;
      } else {
...
var parseQuote = function parseQuote(author, text) {
  document.getElementById("text").innerHTML = text;
  if (author !== '') {
    document.getElementById("author").innerHTML = "-- " + author;
  } else {
    // do NOT post the author's name if it does not exist
